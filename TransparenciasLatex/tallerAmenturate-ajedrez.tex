...
\begin{frame}[t]
    ...
    \only<1|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound00.eps}
        }
    }
    \only<2|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound01.eps}
        }
    }
    \only<3|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound02.eps}
        }
    }
    \only<4|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound03.eps}
        }
    }
    \only<5|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound04.eps}
        }
    }
    \only<6|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound05.eps}
        }
    }
    \only<7|handout:0>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound06.eps}
        }
    }
    \only<8|handout:1>{
        \rput[lt](0,0){
            \includegraphics[width=0.8\linewidth]{images/branchAndBound/branchAndBound07.eps}
        }
    }
\end{frame}
